...
#define VOXELIZE_SCENE L"VoxelizeScene"
#define PREFIX_SUM L"PrefixSumVoxels"
#define CLUSTERIZE_SCENE L"ClusterVoxels"
#define BUILD_AABB L"BuildAABBsTechnique"
#define CLUSTER_VISIBILITY L"ClusterVisibility"
#define LIT_VOXELS L"LightVoxel"
...
namespace VOX
{
	...
	protected:
		...
		virtual void TechniquePass(VOX::RayTracingContext& commandContext, DirectX::XMUINT3 GroupSize) {}
	...
	protected:
		...
		std::unique_ptr<DX12Lib::PipelineState> m_techniquePSO = nullptr;
	};
}
