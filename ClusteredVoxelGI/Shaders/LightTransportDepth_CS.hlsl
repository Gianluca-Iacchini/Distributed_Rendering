...
RWByteAddressBuffer gIndirectLightUpdatedVoxelsBitmap : register(u3, space1);
RWByteAddressBuffer gGaussianUpdatedVoxelsBitmap : register(u4, space1);
RWStructuredBuffer<uint3> gGaussianDispatchIndirectBuffer : register(u5, space1);
RWStructuredBuffer<uint3> gIndirectLightDispatchIndirectBuffer : register(u6, space1);
