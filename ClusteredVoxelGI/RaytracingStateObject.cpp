...
void CVGI::RaytracingStateObject::Finalize()
{
...
void CVGI::RaytracingStateObject::Use(DX12Lib::CommandList& commandList) const
{
	commandList.GetDXR()->SetPipelineState1(m_stateObject.Get());
}

void CVGI::RaytracingStateObject::UseRootSignature(DX12Lib::CommandList& commandList) const
{
	commandList.Get()->SetComputeRootSignature(m_rootSignature->Get());
}

void CVGI::RaytracingStateObject::SetRecursionDepth(UINT maxRecursionDepth)
{
...
void CVGI::RaytracingStateObject::SetAttributeAndPayloadSize(UINT attributeSize, UINT payloadSize)
{
...
void CVGI::RaytracingStateObject::SetLocalRootSignature(std::wstring exportName, std::shared_ptr<DX12Lib::RootSignature> rootSignature)
{
...
void CVGI::RaytracingStateObject::SetShaderBytecode(D3D12_SHADER_BYTECODE shaderBytecode)
{
	m_shaderLib = m_raytracingPipeline.CreateSubobject<CD3DX12_DXIL_LIBRARY_SUBOBJECT>();
	m_shaderLib->SetDXILLibrary(&shaderBytecode);
}

void CVGI::RaytracingStateObject::SetShaderEntryPoint(RayTracingShaderType shaderType, std::wstring entryPoint)
{
...
void CVGI::RaytracingStateObject::CreateShaderTables()
{
