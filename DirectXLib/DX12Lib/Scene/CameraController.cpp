...
void DX12Lib::CameraController::Init(DX12Lib::CommandContext& context)
{
...
void CameraController::Update(DX12Lib::CommandContext& context)
{
	...
	m_lastPosition = this->Node->GetPosition();
}

DirectX::XMFLOAT3 DX12Lib::CameraController::GetVelocity()
{
	DirectX::XMFLOAT3 velocity;
	DirectX::XMFLOAT3 position = this->Node->GetPosition();
	float deltaTime = GameTime::GetDeltaTime();

	velocity.x = (position.x - m_lastPosition.x) / deltaTime;
	velocity.y = (position.y - m_lastPosition.y) / deltaTime;
	velocity.z = (position.z - m_lastPosition.z) / deltaTime;
...
void DX12Lib::CameraController::Move(float speed, float deltaTime)
{
...
//void DX12Lib::CameraController::SetRemoteInput(CameraState cameraState, DirectX::XMFLOAT3 clientAbsPos, DirectX::XMFLOAT4 clientAbsRot, UINT64 clientTimestamp)
//{
//	
...
//}
//
//void DX12Lib::CameraController::SetRemoteInput(std::uint8_t cameraBitmask, DirectX::XMFLOAT3 clientAbsPos, DirectX::XMFLOAT4 clientAbsRot, UINT64 timestamp)
//{
...
//
//
//void DX12Lib::CameraController::PredictInput(float speed, float deltaTime)
//{
...
//}
//
//void DX12Lib::CameraController::TrimHistory(UINT64 clientTimestamp)
//{
